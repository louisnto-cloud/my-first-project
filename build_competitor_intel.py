...
def build_enrichment_log():
    ...
    rows=[
     ...
     (TODAY,"Energy drink confirmations","Batch confirmed — no change","5-hour Energy 57mL: 200 mg caf/18 Na/0/4 cal ✓. G FUEL 473mL: 300/10/0/10 ✓. Mtn Dew Rise 473mL: 180/80/0/15 ✓. Adrenaline Shoc 473mL: 300/10/0/15 ✓. Zevia Energy 355mL: 120/0/0/0 ✓. AMP Energy 473mL: 142/95/58g/220 ✓ (PepsiCo brand). Gorgie 355mL: 120/10/0/10 ✓. BUBBL'R 473mL: 69/15/0/10 ✓. Phocus 350mL: 75/0/0/0 ✓","Knowledge/batch","caffeineinformer.com; pepsicoproductfacts.com; energydrinkhub.com"),
     (TODAY,"Premium waters","Batch confirmed — no change","Essentia 1L: pH 9.5/0 caf/10 Na/0/0 ✓. Smartwater Alkaline 1L: 0/0/0/0 ✓. Topo Chico 355mL: 0 caf/20 Na/0/0 ✓ (mineral analysis ~44 mg/L sodium × 0.355 L = 15.6 mg → rounds to 20 mg per 12 oz serving per official label)","Knowledge/batch","essentia.com; coca-colaproductfacts.com; topochico.com mineral report"),
