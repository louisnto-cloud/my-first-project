...
add(brand="Monster",sku="Monster Energy Ultra Zero (White)",category=C4,format="473 mL can",pack=12,flavours="Zero Ultra, Ultra Paradise, Ultra Sunrise, Ultra Watermelon, Ultra Gold",caffeine=140,sodium=370,potassium=None,sugar=0,calories=10,sweetener="Erythritol + sucralose",claims="Zero sugar, light taste, full energy",vband="Very High",vsignal="Best-selling zero-sugar energy line",message="Full Monster energy, zero sugar, lighter taste",why="No sugar plus a lighter flavour than the green can.",unitml=473)
add(brand="Celsius",sku="Celsius Original Sparkling",category=C4,format="355 mL can",pack=12,flavours="Sparkling Orange, Wild Berry, Kiwi Guava, Cola, Fuji Apple Pear, Sparkling Cranberry",caffeine=200,sodium=10,potassium=50,sugar=0,calories=10,sweetener="Sucralose",claims="Accelerates metabolism, MetaPlus blend, zero sugar, vitamins",vband="Very High",vsignal="Fastest-growing energy brand; fitness crossover",message="Functional energy that claims to boost metabolism",why="No sugar plus a fitness/metabolism story, not just caffeine.",unitml=355)
...
add(brand="Ghost",sku="Ghost Energy",category=C4,format="473 mL can",pack=12,flavours="Sour Patch Kids Redberry, Warheads Sour Watermelon, Swedish Fish, Tropical Mango, Orange Cream",caffeine=200,sodium=20,potassium=None,sugar=0,calories=5,sweetener="Sucralose + acesulfame-K",claims="200 mg natural caffeine, zero sugar, licensed-candy flavours, nootropic blend",vband="High",vsignal="Fast-growing lifestyle brand; strong flavour licensing",message="Candy-flavoured zero-sugar energy with a focus blend",why="Novel licensed-candy flavours plus zero sugar.",unitml=473)
...
add(brand="BODYARMOR",sku="BODYARMOR Sports Drink",category=C2,format="473 mL bottle",pack=12,flavours="Fruit Punch, Strawberry Banana, Orange Mango, Mixed Berry, Tropical Punch",caffeine=0,sodium=30,potassium=350,sugar=21,calories=90,sweetener="Cane sugar",claims="Potassium-packed electrolytes, coconut water, vitamins, no artificial",vband="High",vsignal="Fast-growing premium sports drink (Coca-Cola owned)",message="Premium, natural sports hydration with potassium",why="Coconut-water electrolytes and a cleaner label than legacy brands.",unitml=473)
...
add(brand="Prime",sku="Prime Hydration",category=C2,format="500 mL bottle",pack=12,flavours="Blue Raspberry, Tropical Punch, Ice Pop, Lemon Lime, Strawberry Watermelon, Meta Moon",caffeine=0,sodium=10,potassium=700,sugar=0,calories=20,sweetener="Sucralose + acesulfame-K",claims="Zero sugar, BCAAs, electrolytes, coconut water, vitamins",vband="High",vsignal="Influencer hype; strong youth pull",message="Hype-brand zero-sugar hydration with BCAAs",why="Brand cachet plus zero sugar and added BCAAs.",unitml=500)
...
add(brand="GT's",sku="GT's Synergy Raw Kombucha",category=C3,format="480 mL bottle",pack=12,flavours="Trilogy, Gingerade, Gingerberry, Strawberry Lemonade, Cosmic Cranberry",caffeine=10,sodium=10,potassium=None,sugar=6,calories=30,sweetener="Naturally fermented (residual)",claims="Raw kombucha, billions of probiotics, gut health",vband="High",vsignal="Kombucha category leader",message="The original raw, probiotic kombucha",why="Authentic raw kombucha from the category pioneer.",unitml=480)
...
add(brand="vitaminwater",sku="vitaminwater (glaceau)",category=C3,format="591 mL bottle",pack=12,flavours="XXX Acai-Blueberry-Pomegranate, Power-C Dragonfruit, Focus Kiwi-Strawberry, Energy Tropical Citrus",caffeine=50,sodium=0,potassium=None,sugar=27,calories=120,sweetener="Cane sugar + crystalline fructose",claims="Added vitamins (B, C), function-by-flavour",vband="High",vsignal="Established functional water; mass distribution",message="Flavoured water with a vitamin function story",why="Familiar vitamin-enhanced water in many functional flavours.",unitml=591)
...
order=["README & Methodology","Executive Dashboard","Data Dictionary",
 ...
 "Velocity Estimate","Flavour Map","Live-Capture Protocol","QA & Integrity","Sources"]
