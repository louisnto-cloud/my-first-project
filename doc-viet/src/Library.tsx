...
import { awardOnce, isMonthUnlocked, XP, type DVProgress } from './engine';
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-800 p-5 text-white shadow-lg">
        ...
        <h2 className="text-xl font-black">Thư viện truyện — Story Library</h2>
        <p className="text-sm opacity-90">12 graded Vietnamese stories — read along with the audio, tap words you don't know, then take the quiz.</p>
      </div>
...
function StoryReader({ story, progress, apply, onBack }: {
  ...
  return (
    <div className={`space-y-4 ${textSize === 'large' ? 'dv-lg' : ''}`}>
