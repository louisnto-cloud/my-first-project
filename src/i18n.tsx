...
const STRINGS: Record<string, { en: string; vi: string }> = {
  ...
  'streak.3': { en: 'Three days in a row — you\'re building a habit!', vi: 'Ba ngày liên tiếp — bạn đang tạo thói quen!' },
  'streak.7': { en: 'One full week! Your English brain is on fire.', vi: 'Trọn một tuần! Cực kỳ tuyệt vời.' },
  'streak.14': { en: 'Two weeks strong. This is who you are now.', vi: 'Hai tuần liên tiếp. Bạn đã thành cao thủ!' },
  'streak.30': { en: 'A whole month! Serious dedication.', vi: 'Cả một tháng! Rất kiên trì.' },
  'streak.50': { en: '50 days — you\'re unstoppable.', vi: '50 ngày — không thể cản!' },
  'streak.100': { en: '100 days. Legendary.', vi: '100 ngày. Huyền thoại.' },
  'streak.keepGoing': { en: 'Keep going!', vi: 'Tiếp tục nào!' },
